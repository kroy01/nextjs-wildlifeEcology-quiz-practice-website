...
export const questionsByWeek: { [week: string]: Question[] } = {
	...
	week2: [
		{
			question: "Hierarchy emerges almost inevitably through a wide variety of evolutionary processes, for the simple reason that hierarchical structures are ___",
			options: [
				"perfect",
				"imperfect",
				"stable",
	...
	week6: [
		...
		{
			question: "Lithosphere is an example of",
			options: [
				"hydrosere",
				"xerosere",
				"psammosere",
	...
	week9: [
		...
		},
		{
			...
			options: ["high birth rate, low death rate to low birth rate, low death rate", "low birth rate, high death rate to low birth rate, low death rate", "high birth rate, high death rate to low birth rate, low death rate", "high birth rate, high death rate to low birth rate, high death rate"],
		...
		},
		{
			...
			options: [
				...
				"opulation grows in arithmetic progression, food supply increases in geometric progression",
			],
